...
void ParameterHandler::populate_sequence()
{
  ...
  for (pugi::xpath_node_set::const_iterator it = tools.begin(); it != tools.end(); ++it)
  {
    ...
    item.Phi_1_sm_r = node.node().attribute("Phi_1_sm_r").as_double(0.00);
    item.Amp_1_sm_l = node.node().attribute("Amp_1_sm_l").as_double(0.00);
    item.Phi_1_sm_l = node.node().attribute("Phi_1_sm_l").as_double(0.00);
    item.Amp_1_sp_r = node.node().attribute("Amp_1_sp_r").as_double(0.00);
    item.Phi_1_sp_r = node.node().attribute("Phi_1_sp_r").as_double(0.00);
    item.Amp_1_sp_l = node.node().attribute("Amp_1_sp_l").as_double(0.00);
    item.Phi_1_sp_l = node.node().attribute("Phi_1_sp_l").as_double(0.00);
    item.Amp_2_sm_r = node.node().attribute("Amp_2_sm_r").as_double(0.00);
    item.Phi_2_sm_r = node.node().attribute("Phi_2_sm_r").as_double(0.00);
    item.Amp_2_sm_l = node.node().attribute("Amp_2_sm_l").as_double(0.00);
    item.Phi_2_sm_l = node.node().attribute("Phi_2_sm_l").as_double(0.00);
    item.Amp_2_sp_r = node.node().attribute("Amp_2_sp_r").as_double(0.00);
    item.Phi_2_sp_r = node.node().attribute("Phi_2_sp_r").as_double(0.00);
    item.Amp_2_sp_l = node.node().attribute("Amp_2_sp_l").as_double(0.00);
    item.Phi_2_sp_l = node.node().attribute("Phi_2_sp_l").as_double(0.00);
